...
import com.kangyonggan.app.weixin.biz.util.AopUtil;
import com.kangyonggan.app.weixin.biz.util.DateUtils;
import com.kangyonggan.app.weixin.biz.util.PropertiesUtil;
import com.kangyonggan.app.weixin.model.annotation.LogTime;
...
public class LogAop {
    ...
    @Pointcut("execution(* com.kangyonggan.app.weixin.biz..*.*(..))")
